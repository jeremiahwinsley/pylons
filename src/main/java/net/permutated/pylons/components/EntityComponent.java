...
public record EntityComponent(Identifier registryKey, String descriptionId) {
    public static Codec<EntityComponent> BASIC_CODEC = RecordCodecBuilder.create(
        instance -> instance.group(
            Identifier.CODEC.fieldOf(Constants.NBT.REGISTRY).forGetter(EntityComponent::registryKey),
