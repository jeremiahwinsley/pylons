...
public class ModRegistry {
    ...
    public static final RegistryObject<TileEntityType<InterdictionPylonTile>> INTERDICTION_PYLON_TILE = tile(INTERDICTION_PYLON, InterdictionPylonTile::new);
    ...
    public static final RegistryObject<ContainerType<InterdictionPylonContainer>> INTERDICTION_PYLON_CONTAINER = container(Constants.INTERDICTION_PYLON, InterdictionPylonContainer::new);
